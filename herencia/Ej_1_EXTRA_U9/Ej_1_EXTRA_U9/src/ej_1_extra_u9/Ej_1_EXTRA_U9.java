...
public class Ej_1_EXTRA_U9 {
     ...
     * la fecha de alquiler, fecha de devolución, la
     ...
     * calcula sacando el módulo normal y sumándole el atributo particular de
     * cada barco. 
     * En los veleros se suma el número de mástiles, en los barcos a
     ...
     * deberemos programar en Java, las clases y los métodos necesarios que
     * permitan al usuario elegir el barco que quiera alquilar y mostrarle el
     * precio final de su alquiler.
     */
    public static void main(String[] args) {
        /*Alquiler a= new Alquiler("Fernando Chiquitoxd", 25222444, 4, LocalDate.of(2022,5, 13), LocalDate.of(2022,5,15), new Yate(3, 10, 556688, 2, 2010));
        a.mostrar();
        a.precioAlquiler();*/
